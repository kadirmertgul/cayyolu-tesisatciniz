...
const body = 'Çayyolu - Ümitköy - Mesa Koru - Yaşamkent civarındaki tüm işlemlere anında müdahale. <br /> Hemen tıkla. <br /> İstar mail ile ister telefonla anında kapında...'
const buttons = [
    {
        title: 'Mail Gönder',
        url: 'mailto:info@cayyolutesisatcisi.com',
        variant: 'elevated',
        color: 'secondary'
    },
    {
        title: 'Whatsapp Araması',
        url: 'https://wa.me/+905523343071',
        variant: 'outlined',
        color: 'secondary'
    }
]
